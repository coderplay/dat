...
//    DoubleArrayTrie<Character, String> charTrie 
//      = new DoubleArrayTrie<Character, String>(CharacterKeyAnalyzer.CHAR);
//    charTrie.put('c', "c");
//    charTrie.put('p', "p");
//    charTrie.put('l', "l");
//    charTrie.put('t', "t");
...
//    DoubleArrayTrie<Character, String> charTrie = new DoubleArrayTrie<Character, String>(CharacterKeyAnalyzer.CHAR);
//    charTrie.put('c', "c");
//    charTrie.put('p', "p");
//    charTrie.put('l', "l");
//    charTrie.put('t', "t");
...
//    DoubleArrayTrie<Integer, String> intTrie = new DoubleArrayTrie<Integer, String>(IntegerKeyAnalyzer.INSTANCE);
//    intTrie.put(1, "One");
//    intTrie.put(5, "Five");
//    intTrie.put(4, "Four");
//    intTrie.put(2, "Two");
...
//    DoubleArrayTrie<String, String> trie = new DoubleArrayTrie<String, String>(StringKeyAnalyzer.CHAR);
//    
...
//    DoubleArrayTrie<String, String> trie 
//      = new DoubleArrayTrie<String, String>(StringKeyAnalyzer.CHAR);
//    
